    ...
    render() {
        return (
            <div className="ui container search-form">
                <p>Type in the name of a playlist or select from your own to begin playing! The playlist must have at least 30 songs.</p>
                ...
                <div className="ui container search-form">
                    ...
                    <button className="user-playlist" onClick={() => this.props.selectPlaylist()}>Select Playlist</button>
                </div>
                <select
